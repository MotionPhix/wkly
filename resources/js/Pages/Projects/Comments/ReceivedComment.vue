  ...
  <li class="flex ms-auto gap-x-2 sm:gap-x-4">
    ...
    <div class="grow text-end space-y-3">
      ...
      <div class="inline-flex flex-col justify-end">
        ...
        <!-- Card -->
        <div class="inline-block bg-gray-300 dark:bg-blue-600 rounded-lg p-4 shadow-sm">

          <div
            class="prose text-left prose-sm dark:prose-invert"
            v-html="props.comment.body">
          </div>

          <!-- Files -->
          <div
            class="grid gap-4 my-2.5"
        ...
        <span
          ...
          <svg
            class="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
